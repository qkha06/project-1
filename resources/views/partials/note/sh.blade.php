            ...
            <div class="shC">
              <div class="shL">
                <div data-text="Facebook">
                  <a aria-label="Facebook" class="fb" href="https://www.facebook.com/sharer.php?u={{ route('note.show', $data->alias) }}" rel="noopener" target="_blank">
                ...
                <div data-text="WhatsApp">
                  <a aria-label="Whatsapp" class="wa" href="https://api.whatsapp.com/send?text={{ route('note.show', $data->alias) }}" rel="noopener" target="_blank">
                    <svg viewBox="0 0 64 64">
                ...
                <div data-text="Twitter">
                  <a aria-label="Twitter" class="tw" href="https://twitter.com/share?url={{ route('note.show', $data->alias) }}" rel="noopener" target="_blank">
                    <svg viewBox="0 0 64 64">
                ...
                <div data-text="Telegram">
                  <a aria-label="Telegram" class="tg" href="https://t.me/share/url?url={{ route('note.show', $data->alias) }}" rel="noopener" target="_blank">
                    <svg viewBox="0 0 64 64">
                ...
                <div data-text="Pinterest">
                  <a aria-label="Pinterest" class="pt" data-pin-config="beside" href="https://pinterest.com/pin/create/button/?url=#" rel="noopener" target="_blank">
                    <svg viewBox="0 0 64 64">
                ...
                <div data-text="LinkedIn">
                  <a aria-label="Linkedin" class="ld" href="https://www.linkedin.com/sharing/share-offsite/?url={{ route('note.show', $data->alias) }}" rel="noopener" target="_blank">
                    <svg viewBox="0 0 64 64">
                ...
                <div data-text="Line">
                  <a aria-label="Line" class="ln" href="https://timeline.line.me/social-plugin/share?url={{ route('note.show', $data->alias) }}" rel="noopener" target="_blank">
                ...
                <div data-text="Email">
                  <a aria-label="Email" class="em" href="mailto:?body={{ route('note.show', $data->alias) }}" target="_blank">
              ...
              <div class="cpL" data-message="Copy to clipboard" data-text="or copy link">
                <div class="cpLb">
                  ...
                  <input id="getlink" onclick="this.select()" readonly="readonly" value="{{ route('note.show', $data->alias) }}">
                  <label for="getlink" onclick="copyf()">Copy</label>
                </div>
