                    ...
                    <div class="brdCmb" itemscope="itemscope" itemtype="https://schema.org/BreadcrumbList">
                        ...
                        <div class="lb" itemprop="itemListElement" itemscope="itemscope"
                            ...
                            @if (isset($article_data['category']) && !empty($article_data['category']))
                                <a href="https://imagz.jagodesain.com/search/label/{{ $article_data['category']['name'] }}"
                                    itemprop="item"><span itemprop="name">{{ $article_data['category']['name'] }}</span></a>
                            @else
                    ...
                    <div class="pSh">
                        <div class="pShc" data-text="Share:">
                            ...
                            <a aria-label="Twitter" class="c tw" data-text="Tweet"
                                href="https://twitter.com/share?url={{ route('blog.show', $article_data['slug']) }}"
                                rel="noopener" role="button" target="_blank">
                                <svg viewBox="0 0 64 64">
                                    <path
                                    ...
                                    <div class="shL">
                                        ...
                                        <div data-text="Telegram">
                                            <a aria-label="Telegram"
                                                href="https://t.me/share/url?url={{ route('blog.show', $article_data['slug']) }}"
                                                rel="noopener" target="_blank">
                                                <svg viewBox="0 0 64 64">
                                                    <path
                                        ...
                                        <div data-text="Email">
                                            <a aria-label="Email"
                                                href="mailto:?body={{ route('blog.show', $article_data['slug']) }}"
                                                target="_blank">
