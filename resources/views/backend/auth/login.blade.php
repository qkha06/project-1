            ...
            <div class="form login">
                ...
                <div class="form-body">
                    ...
                    <form action="{{ route('auth.login') }}" method="post">
                        @csrf
                        <label class="form-label" for="email">Tên tài khoản hoặc Email <span style="color: #f1416c">*</span></label>
                        <input class="form-control" type="text" id="email" name="email" placeholder="Ví dụ: myname@example.com" value="{{ old('name') }}" required>
