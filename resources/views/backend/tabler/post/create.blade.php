...
<div class="row row-deck">
    <div class="col-12">
        <form class="form card" action="{{ route('admin.post.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-12 col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" id="post-title" name="title" placeholder="Enter post title" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="form-label required" for="post-slug">Slug</label>
                            <input type="text" id="post-slug" name="slug" placeholder="Enter post slug" class="form-control">
                        </div>
                        <div class="mb-3">
